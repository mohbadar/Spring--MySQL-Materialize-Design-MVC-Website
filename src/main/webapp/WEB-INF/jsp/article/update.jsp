...
<section>
    <div class="row">
        <div class="section col s12 m12 l12">
            ...
            <h5 class="center-align cyan-text">Edit Article</h5>
                ...
                <form action="/save-announcement" method="post"  enctype="multipart/form-data" >
                    ...
                    <div class="row col s12 m12 l12">
                        ...
                        <div class="input-field col s12 m12 l12">
                            ...
                            <input id="title" name="title" type="text" value="${article.title}"  required  minlength="3" maxlength="255" class="validate ">
                    ...
                    <div class="row col s12 m12 l12">
                        ...
                        <div class="input-field col s12 m12 l12">
                            <i class="mdi-action-account-box prefix"></i>
                            <textarea id="content" name="content"   required  class="validate editor materialize-textarea">${article.content}</textarea>
                    ...
                    <div class="row col s12 m12 l12">
                        ...
                        <div class="input-field col s12 m12 l12">
                            <i class="mdi-action-account-box prefix"></i>
                            <textarea id="remark" name="remark"   required  class="validate editor materialize-textarea">${article.remark}</textarea>
