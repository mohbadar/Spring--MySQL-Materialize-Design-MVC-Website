    ...
    <div class="container">
        <div class="row">
            <div class="col s12 m12 l12">
                ...
                <h5 class="breadcrumbs-title">System News</h5>
                <ol class="breadcrumb">
                    <li><a href="#">Home</a></li>
...
<section>
    <div class="row">
        <div class="section col s12 m12 l12">
            ...
            <h5 class="center-align cyan-text">List Of All News/h5><br>
                ...
                <table  class="responsive-table centered">
                    ...
                    <c:forEach items="${news}" var="n">
                        <tr>
                            ...
                            <td class="cyan-text">
                                <a data-toggle="tooltip" title="Update" href="/update-news/${n.id}" style="cursor: pointer;" class="delete">
                            ...
                            <td class="cyan-text">
                                <a data-toggle="tooltip" title="Delete" href="/delete-news/${n.id}" style="cursor: pointer;" class="delete">
